...
AchievementProgressWidget::AchievementProgressWidget(QWidget* parent) : QWidget(parent)
{
  ...
  connect(&Settings::Instance(), &Settings::ConfigChanged, this,
          &AchievementProgressWidget::LoadSettings);
}

void AchievementProgressWidget::CreateLayout()
{
...
void AchievementProgressWidget::ConnectWidgets()
{
  connect(m_common_integration_enabled_input, &QCheckBox::toggled, this,
          &AchievementProgressWidget::SaveSettings);
  ...
  connect(m_common_integration_enabled_input, &QCheckBox::toggled, this,
          &AchievementProgressWidget::ToggleRAIntegration);
  connect(m_common_login_button, &QPushButton::pressed, this, &AchievementProgressWidget::Login);
  connect(m_common_logout_button, &QPushButton::pressed, this, &AchievementProgressWidget::Logout);
  connect(m_common_achievements_enabled_input, &QCheckBox::toggled, this,
          &AchievementProgressWidget::ToggleAchievements);
  //  connect(m_common_leaderboards_enabled_input, &QCheckBox::toggled, this,
  //          &AchievementProgressWidget::ToggleLeaderboards);
  //  connect(m_common_rich_presence_enabled_input, &QCheckBox::toggled, this,
  //          &AchievementProgressWidget::ToggleRichPresence);
  connect(m_common_hardcore_enabled_input, &QCheckBox::clicked, this,
          &AchievementProgressWidget::ToggleHardcore);
  connect(m_common_badge_icons_enabled_input, &QCheckBox::toggled, this,
          &AchievementProgressWidget::ToggleBadgeIcons);
  //  connect(m_common_test_mode_enabled_input, &QCheckBox::toggled, this,
  //          &AchievementProgressWidget::ToggleTestMode);
  connect(m_common_unofficial_enabled_input, &QCheckBox::toggled, this,
          &AchievementProgressWidget::ToggleUnofficial);
  //  connect(m_common_encore_enabled_input, &QCheckBox::toggled, this,
  //          &AchievementProgressWidget::ToggleEncore);
}

void AchievementProgressWidget::OnControllerInterfaceConfigure()
{
...
void AchievementProgressWidget::LoadSettings()
{
...
void AchievementProgressWidget::SaveSettings()
{
...
void AchievementProgressWidget::ToggleRAIntegration()
{
...
void AchievementProgressWidget::Login()
{
...
void AchievementProgressWidget::Logout()
{
  Achievements::Logout();
  Config::SetBaseOrCurrent(Config::RA_API_TOKEN, "");
  Config::Save();
...
void AchievementProgressWidget::ToggleAchievements()
{
...
/*
void AchievementProgressWidget::ToggleLeaderboards()
{
...
void AchievementProgressWidget::ToggleRichPresence()
{
...
void AchievementProgressWidget::ToggleHardcore()
{
...
void AchievementProgressWidget::ToggleBadgeIcons()
{
...
/*
void AchievementProgressWidget::ToggleTestMode()
{
  if (Config::Get(Config::RA_TEST_MODE_ENABLED))
  else
}*/

void AchievementProgressWidget::ToggleUnofficial()
{
...
/*
void AchievementProgressWidget::ToggleEncore()
{
