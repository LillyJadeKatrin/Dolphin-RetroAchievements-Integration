...
void AchievementsWindow::CreateMainLayout()
{
  ...
  m_tab_widget->addTab(GetWrappedWidget(new AchievementSettingsWidget(m_tab_widget, this), this, 125, 100),
      tr("Settings"));
  m_tab_widget->addTab(
      GetWrappedWidget(progress_widget, this, 125, 100),
      tr("Progress"));
  ...
  m_tab_widget->addTab(
      GetWrappedWidget(leaderboard_widget, this, 125, 100), tr("Leaderboard"));
